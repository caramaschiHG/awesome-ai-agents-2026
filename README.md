...
| [Oracle Bridge / Bride](https://tools.gracestack.se/oracle-bridge-landing.html) | Self-hosted cognitive agent with HDC (Hyperdimensional Computing), Active Inference, and Ebbinghaus memory. REST API, anomaly detection, emotional modeling. | Free trial / 29 kr lifetime / 499 kr/mo |
