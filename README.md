...
| [Dakera](https://github.com/dakera-ai/dakera-deploy) | Persistent memory layer for agents: hybrid BM25 + vector retrieval, temporal reasoning, importance-weighted decay. |
