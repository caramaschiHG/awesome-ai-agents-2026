...
| [Heym](https://github.com/heymrun/heym) | Self-hosted visual platform for multi-agent workflows, RAG, MCP, human-in-the-loop controls, evals, and observability. | Free (self-hosted) / Enterprise |
