...
| [Ouroboros](https://github.com/razzant/ouroboros) | General-purpose agent with persistent identity and memory, reviewed self-modification, multi-agent coordination, and optional local GGUF inference. |
