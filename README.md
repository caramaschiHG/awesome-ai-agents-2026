...
| [AgentBridge](https://github.com/raysonmeng/agent-bridge) | Local MIT CLI that keeps Claude Code and Codex as live peers in one session (mid-turn review, task split, quota-boundary handoff). | Free (OSS) |
