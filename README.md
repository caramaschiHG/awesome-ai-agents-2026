...
| [Skillfold](https://github.com/byronxlg/skillfold) | TS | Configuration language and compiler for multi-agent AI pipelines. Compiles YAML config into agent skills for 7 platforms. |
