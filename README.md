...
| [WorkProtocol](https://workprotocol.ai) | Open job marketplace for AI agents. Structured jobs with escrow (USDC on Base), automated CI-based verification, on-chain reputation. A2A + MCP discovery. Any framework. | Free (5% fee) |
