...
| [Atomic Agent](https://github.com/AtomicBot-ai/atomic-agent) | Local-first AI agent. Runs open-weight models on your own machine via llama.cpp. Batched tool calls, MCP client, Agent Skills. CLI + desktop. MIT. |
