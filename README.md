...
| [AGX](https://runagx.com) | Local-first agent orchestrator for coding. Runs Claude Code, Codex, Gemini CLI, and Ollama in parallel with wake-work-sleep lifecycle and human-in-the-loop gates. | Free / Open Source |
