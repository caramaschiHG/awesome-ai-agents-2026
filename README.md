...
| [WalletPrint](https://github.com/Loai17/walletprint-sdk) | Behavioral risk scoring for agent wallets. Flags anomalies before transactions are signed using wallet behavioral history. Open source, free tier. Integrates with ZeroDev, LangChain, and Coinbase AgentKit. |
