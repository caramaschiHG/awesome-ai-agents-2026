...
| [Bernstein](https://github.com/chernistry/bernstein) | Py | Governance layer for AI agents. Deterministic scheduling, worktree isolation, signed audit trail. No model in the coordination loop. |
