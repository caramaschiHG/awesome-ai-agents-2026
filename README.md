...
| Platform | Description | Pricing |
|----------|-------------|---------|
| [AgentLine](https://agentline.cloud) | Open-source telephony API for AI agents — give agents real phone numbers for voice calls & SMS. Works with OpenClaw, Hermes, Claude Code, and any LLM via webhooks or MCP. | $2/number, $0.10/min |
