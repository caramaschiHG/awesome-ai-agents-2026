...
| [Codex Infinity](https://codex-infinity.com) | Autonomous coding agent (Codex CLI fork). Auto-continuation, parallel multi-agent runs, CI repair loops, cloud sessions. | Free CLI / SaaS |
